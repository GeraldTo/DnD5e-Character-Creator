    ...
    if (props.classType) {
        return (
            <div className="Ability">
                ...
                <Rolls />
                <ScoreList race={props.race} classType={props.classType} feats={props.feats} abilityMod={props.abilityMod} setabilityMod={props.setabilityMod} totalScore={props.totalScore} setTotalScore={props.setTotalScore} />
